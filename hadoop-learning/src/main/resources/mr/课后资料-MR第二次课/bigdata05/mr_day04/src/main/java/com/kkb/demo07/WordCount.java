...
public class WordCount extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        //指定我们去哪一个路径读取文件
        TextInputFormat.addInputPath(job,new Path("file:///C:\\Users\\admin\\Desktop\\高级05\\MR第一次\\8、mapreduce的combiner过程\\数据"));
        ...
        TextOutputFormat.setOutputPath(job,new Path("C:\\Users\\admin\\Desktop\\高级05\\MR第一次\\8、mapreduce的combiner过程\\数据\\out"));
