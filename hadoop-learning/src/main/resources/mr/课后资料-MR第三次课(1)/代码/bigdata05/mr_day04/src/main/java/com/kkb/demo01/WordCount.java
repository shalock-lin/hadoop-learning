...
public class WordCount extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        //指定我们去哪一个路径读取文件
        CombineTextInputFormat.addInputPath(job,new Path("file:///C:\\Users\\admin\\Desktop\\高级05\\MR第一次\\1、wordCount_input\\数据"));
        ...
        TextOutputFormat.setOutputPath(job,new Path("C:\\Users\\admin\\Desktop\\高级05\\MR第一次\\1、wordCount_input\\数据\\wc"));
