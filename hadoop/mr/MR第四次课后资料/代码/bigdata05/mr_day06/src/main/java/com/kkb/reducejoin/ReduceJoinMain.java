...
public class ReduceJoinMain  extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        TextInputFormat.addInputPath(job,new Path("file:///C:\\Users\\admin\\Desktop\\高级05\\MR第一次\\11、join操作\\数据\\reduce端join\\input"));
        ...
        TextOutputFormat.setOutputPath(job,new Path("file:///C:\\Users\\admin\\Desktop\\高级05\\MR第一次\\11、join操作\\数据\\reduce端join\\input\\out"));
