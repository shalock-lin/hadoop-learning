...
//        configuration.set("mapreduce.output.fileoutputformat.compress.type","RECORD");//如果输出是SequenceFile格式的话，才起作用
//        configuration.set("mapreduce.output.fileoutputformat.compress.codec","org.apache.hadoop.io.compress.SnappyCodec");

        Job job = Job.getInstance(configuration, "mrdemo22222");
        ...
        //指定我们去哪一个路径读取文件
        TextInputFormat.addInputPath(job,new Path("file:///C:\\Users\\admin\\Desktop\\高级05\\MR第一次\\1、wordCount_input\\数据"));
        //TextInputFormat.addInputPath(job,new Path("hdfs://node01:8020/wordcount_input"));
        //FileInputFormat.addInputPath(job,new Path("hdfs://node01:8020/wordcount_input"));
        ...
        TextOutputFormat.setOutputPath(job,new Path("file:///C:\\Users\\admin\\Desktop\\高级05\\MR第一次\\1、wordCount_input\\数据\\out"));
        //TextOutputFormat.setOutputPath(job,new Path("hdfs://node01:8020/wordcount_output_6666"));
